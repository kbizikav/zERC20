 ...
 * @returns {any}
 */
export function derive_payment_advice(seed_hex, payment_advice_id_hex, recipient_chain_id, recipient_address_hex) {
 ...
 * @returns {any}
 */
export function derive_invoice_single(seed_hex, invoice_id_hex, recipient_chain_id, recipient_address_hex) {
    const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function derive_invoice_batch(seed_hex, invoice_id_hex, sub_id, recipient_chain_id, recipient_address_hex) {
    const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(invoice_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function build_full_burn_address(recipient_chain_id, recipient_address_hex, secret_hex, tweak_hex) {
...
/**
 * @param {string} full_burn_address_hex
 * @returns {any}
 */
export function decode_full_burn_address(full_burn_address_hex) {
 ...
 * @returns {string}
 */
export function general_recipient_fr(chain_id, recipient_address_hex, tweak_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(recipient_address_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function aggregation_root(snapshot_hex) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {any}
 */
export function aggregation_merkle_proof(snapshot_hex, index) {
...
const SingleWithdrawWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
const WithdrawNovaWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('zkerc20_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
