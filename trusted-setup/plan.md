...
4. Replace Groth16 `setup` in artifact generation with arkworks-phase2 `Transcript`and serialize pk/vk.
...
- arkworks-phase2 is imported from `/https://github.com/kbizikav/arkworks-phase2.git`.
